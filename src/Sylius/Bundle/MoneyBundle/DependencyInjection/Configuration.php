                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ...
                        ->arrayNode('google_provider')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('yahoo_provider')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('exchange_rate')->defaultValue('Sylius\Bundle\MoneyBundle\ExchangeRate\Provider\YahooProvider')->end()
                            ->end()
                        ->end()
                        ->arrayNode('european_central_bank_provider')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('exchange_rate')->defaultValue('Sylius\Bundle\MoneyBundle\ExchangeRate\Provider\EuropeanCentralBankProvider')->end()
                            ->end()
                        ->end()
                        ->arrayNode('factory')
                            ->addDefaultsIfNotSet()
